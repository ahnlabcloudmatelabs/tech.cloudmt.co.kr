...
1. EC2 Policy 설정  
    ![image](/files/blog/2020-12-10/image1.png)  
    ![image](/files/blog/2020-12-10/image2.png)  
...
1. EC2 Role 설정  
    ...
    ![image](/files/blog/2020-12-10/image3.png)  
    ![image](/files/blog/2020-12-10/image4.png)  
    SSM을 사용하기 위한 기본 Policy를 선택  
    ![image](/files/blog/2020-12-10/image5.png)  
    이전에 작성한 Policy를 선택  
    ![image](/files/blog/2020-12-10/image6.png)  
...
1. VPC 앤드포인트 설정  
    ...
    ![image](/files/blog/2020-12-10/image7.png)  
    Service Name을 검색합니다.  
    (\*ssm, ssmmessages, ec2messages, s3 총 4개를 하나씩 생성해야합니다.)  
    ![image](/files/blog/2020-12-10/image8.png)  
    앤드포인트 및 EC2 에 사용할 SG을 선택합니다.
    ![image](/files/blog/2020-12-10/image9.png)  
    위 과정을 반복하여 아래와 같이 총 4개의 앤드포인트를 생성합니다.
    ![image](/files/blog/2020-12-10/image10.png)  
    라우팅 테이블 확인  
    ![image](/files/blog/2020-12-10/image11.png)  
    IGW 및 NAT가 없으므로 해당 라우팅 테이블이 속한 서브넷에서는 외부인터넷망에 접근이 불가능한 것을 확인할 수 있습니다.  

1. EC2 생성  
    EC2 &gt; Launch Instance를 선택합니다.  
    ![image](/files/blog/2020-12-10/image12.png)  
    ![image](/files/blog/2020-12-10/image13.png)  
